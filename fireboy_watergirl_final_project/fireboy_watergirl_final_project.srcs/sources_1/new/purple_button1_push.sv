module purple_button2_push(
    input logic [9:0] x_pos, y_pos, 
    input logic Reset, frame_clk,
    output logic Purple_Button_Down_2
    );
    ...
    logic flag = 1'b0;
    always_comb begin
        if(x_pos >= 520 && x_pos < 540 && y_bot-5 >= 178 && y_bot-5 < 188) begin
             flag = 1'b1;
