...
module death_checker_wg(
    ...
    logic [14:0] addr_bottom;
    logic [14:0] addr_left_end, addr_right_end;
    ...
    watergirl_death_map_palette mp1(.index(index1), .red(map_red1), .green(map_green1), .blue(map_blue1));
    watergirl_death_map_palette mp2(.index(index2), .red(map_red2), .green(map_green2), .blue(map_blue2));
