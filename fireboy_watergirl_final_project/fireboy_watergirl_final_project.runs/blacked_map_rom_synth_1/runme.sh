...
HD_PWD='C:/Users/Warre/fireboy_watergirl_final_project/fireboy_watergirl_final_project.runs/blacked_map_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blacked_map_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blacked_map_rom.tcl
