...
HD_PWD='C:/Users/Warre/fireboy_watergirl_final_project/fireboy_watergirl_final_project.runs/girl_right2_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log girl_right2_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source girl_right2_rom.tcl
