...
namespace eval ::optrace {
  variable script "C:/Users/Warre/fireboy_watergirl_final_project/fireboy_watergirl_final_project.runs/impl_1/mb_final_top.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet C:/Users/Warre/fireboy_watergirl_final_project/fireboy_watergirl_final_project.runs/synth_1/mb_final_top.dcp
...
OPTRACE "link_design" START { }
  set_param project.isImplRun true
  link_design -top mb_final_top -part xc7s50csga324-1 
...
OPTRACE "Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force mb_final_top_opt.dcp
OPTRACE "Opt Design: write_checkpoint" END { }
OPTRACE "opt_design reports" START { REPORT }
  create_report "impl_1_opt_report_drc_0" "report_drc -file mb_final_top_drc_opted.rpt -pb mb_final_top_drc_opted.pb -rpx mb_final_top_drc_opted.rpx"
...
OPTRACE "Place Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force mb_final_top_placed.dcp
OPTRACE "Place Design: write_checkpoint" END { }
OPTRACE "place_design reports" START { REPORT }
  create_report "impl_1_place_report_io_0" "report_io -file mb_final_top_io_placed.rpt"
  create_report "impl_1_place_report_utilization_0" "report_utilization -file mb_final_top_utilization_placed.rpt -pb mb_final_top_utilization_placed.pb"
  create_report "impl_1_place_report_control_sets_0" "report_control_sets -verbose -file mb_final_top_control_sets_placed.rpt"
...
OPTRACE "Post-Place Phys Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force mb_final_top_physopt.dcp
...
OPTRACE "Route Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force mb_final_top_routed.dcp
OPTRACE "Route Design: write_checkpoint" END { }
OPTRACE "route_design reports" START { REPORT }
  create_report "impl_1_route_report_drc_0" "report_drc -file mb_final_top_drc_routed.rpt -pb mb_final_top_drc_routed.pb -rpx mb_final_top_drc_routed.rpx"
  create_report "impl_1_route_report_methodology_0" "report_methodology -file mb_final_top_methodology_drc_routed.rpt -pb mb_final_top_methodology_drc_routed.pb -rpx mb_final_top_methodology_drc_routed.rpx"
  create_report "impl_1_route_report_power_0" "report_power -file mb_final_top_power_routed.rpt -pb mb_final_top_power_summary_routed.pb -rpx mb_final_top_power_routed.rpx"
  create_report "impl_1_route_report_route_status_0" "report_route_status -file mb_final_top_route_status.rpt -pb mb_final_top_route_status.pb"
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -report_unconstrained -file mb_final_top_timing_summary_routed.rpt -pb mb_final_top_timing_summary_routed.pb -rpx mb_final_top_timing_summary_routed.rpx -warn_on_violation "
  create_report "impl_1_route_report_incremental_reuse_0" "report_incremental_reuse -file mb_final_top_incremental_reuse_routed.rpt"
  create_report "impl_1_route_report_clock_utilization_0" "report_clock_utilization -file mb_final_top_clock_utilization_routed.rpt"
  create_report "impl_1_route_report_bus_skew_0" "report_bus_skew -warn_on_violation -file mb_final_top_bus_skew_routed.rpt -pb mb_final_top_bus_skew_routed.pb -rpx mb_final_top_bus_skew_routed.rpx"
...
OPTRACE "route_design write_checkpoint" END { }
  write_checkpoint -force mb_final_top_routed_error.dcp
...
OPTRACE "read constraints: write_bitstream" END { }
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
  catch { write_mem_info -force -no_partial_mmi mb_final_top.mmi }
  catch { write_bmm -force mb_final_top_bd.bmm }
OPTRACE "write_bitstream setup" END { }
OPTRACE "write_bitstream" START { }
  write_bitstream -force mb_final_top.bit 
OPTRACE "write_bitstream" END { }
OPTRACE "write_bitstream misc" START { }
OPTRACE "read constraints: write_bitstream_post" START { }
OPTRACE "read constraints: write_bitstream_post" END { }
  catch {write_debug_probes -quiet -force mb_final_top}
  catch {file copy -force mb_final_top.ltx debug_nets.ltx}
