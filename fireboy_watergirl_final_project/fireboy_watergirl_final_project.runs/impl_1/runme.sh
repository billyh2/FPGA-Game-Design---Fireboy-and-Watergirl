...
HD_PWD='C:/Users/Warre/OneDrive/Documents/GitHub/ECE385/fireboy_watergirl_final_project/fireboy_watergirl_final_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_final_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mb_final_top.tcl -notrace
