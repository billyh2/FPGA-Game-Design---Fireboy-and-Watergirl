...
HD_PWD='C:/Users/Warre/fireboy_watergirl_final_project/fireboy_watergirl_final_project.runs/yellow_button_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log yellow_button_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source yellow_button_rom.tcl
