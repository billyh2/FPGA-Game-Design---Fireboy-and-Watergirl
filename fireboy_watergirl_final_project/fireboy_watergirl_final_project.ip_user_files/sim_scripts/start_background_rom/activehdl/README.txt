...
#
# Generated by export_simulation on Fri Dec 06 23:18:01 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './start_background_rom.sh' script.

./start_background_rom.sh -reset_run
...
./start_background_rom.sh -noclean_files

For more information on the script, please type './start_background_rom.sh -help'.
