...
#
# Generated by export_simulation on Sun Dec 01 19:31:02 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './girl_right1_rom.sh' script.

./girl_right1_rom.sh -reset_run
...
./girl_right1_rom.sh -noclean_files

For more information on the script, please type './girl_right1_rom.sh -help'.
