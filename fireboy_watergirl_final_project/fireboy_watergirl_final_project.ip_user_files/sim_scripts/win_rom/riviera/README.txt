...
#
# Generated by export_simulation on Fri Dec 13 14:37:40 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './win_rom.sh' script.

./win_rom.sh -reset_run
...
./win_rom.sh -noclean_files

For more information on the script, please type './win_rom.sh -help'.
