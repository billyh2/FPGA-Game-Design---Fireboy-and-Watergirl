...
#
# Generated by export_simulation on Sun Dec 08 22:13:20 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './yellow_button_rom.sh' script.

./yellow_button_rom.sh -reset_run
...
./yellow_button_rom.sh -noclean_files

For more information on the script, please type './yellow_button_rom.sh -help'.
