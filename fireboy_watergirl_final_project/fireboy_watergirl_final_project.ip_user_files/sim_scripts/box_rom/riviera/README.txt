...
#
# Generated by export_simulation on Thu Dec 12 23:33:57 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './box_rom.sh' script.

./box_rom.sh -reset_run
...
./box_rom.sh -noclean_files

For more information on the script, please type './box_rom.sh -help'.
