...
#
# Generated by export_simulation on Sun Dec 08 19:39:00 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './purple_button_rom.sh' script.

./purple_button_rom.sh -reset_run
...
./purple_button_rom.sh -noclean_files

For more information on the script, please type './purple_button_rom.sh -help'.
