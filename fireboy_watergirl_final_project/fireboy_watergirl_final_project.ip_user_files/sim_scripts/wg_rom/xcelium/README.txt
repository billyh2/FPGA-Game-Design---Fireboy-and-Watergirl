...
#
# Generated by export_simulation on Sun Dec 01 13:35:29 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './wg_rom.sh' script.
...
./wg_rom.sh -noclean_files

For more information on the script, please type './wg_rom.sh -help'.
