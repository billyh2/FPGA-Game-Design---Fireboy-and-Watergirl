...
#
# Generated by export_simulation on Thu Dec 12 15:53:47 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './red_diamond_rom.sh' script.

./red_diamond_rom.sh -reset_run
...
./red_diamond_rom.sh -noclean_files

For more information on the script, please type './red_diamond_rom.sh -help'.
