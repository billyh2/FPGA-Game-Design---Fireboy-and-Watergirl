...
#
# Generated by export_simulation on Tue Dec 10 18:29:59 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './boy_rom.sh' script.

./boy_rom.sh -reset_run
...
./boy_rom.sh -noclean_files

For more information on the script, please type './boy_rom.sh -help'.
