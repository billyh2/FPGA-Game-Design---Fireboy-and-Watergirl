...
#
# Generated by export_simulation on Wed Dec 11 21:09:12 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './blue_diamond_rom.sh' script.

./blue_diamond_rom.sh -reset_run
...
./blue_diamond_rom.sh -noclean_files

For more information on the script, please type './blue_diamond_rom.sh -help'.
