...
#
# Generated by export_simulation on Sun Dec 08 17:53:15 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './yellow_board_rom.sh' script.

./yellow_board_rom.sh -reset_run
...
./yellow_board_rom.sh -noclean_files

For more information on the script, please type './yellow_board_rom.sh -help'.
