...
#
# Generated by export_simulation on Tue Dec 10 00:19:25 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './map_rom.sh' script.

./map_rom.sh -reset_run
...
./map_rom.sh -noclean_files

For more information on the script, please type './map_rom.sh -help'.
