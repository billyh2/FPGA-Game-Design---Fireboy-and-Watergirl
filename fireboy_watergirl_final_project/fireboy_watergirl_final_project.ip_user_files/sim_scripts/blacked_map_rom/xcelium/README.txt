...
#
# Generated by export_simulation on Tue Dec 10 00:01:35 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './blacked_map_rom.sh' script.

./blacked_map_rom.sh -reset_run
...
./blacked_map_rom.sh -noclean_files

For more information on the script, please type './blacked_map_rom.sh -help'.
