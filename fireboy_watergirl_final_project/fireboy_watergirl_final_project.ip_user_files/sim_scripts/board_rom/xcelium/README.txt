...
#
# Generated by export_simulation on Thu Dec 05 16:56:30 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './board_rom.sh' script.

./board_rom.sh -reset_run
...
./board_rom.sh -noclean_files

For more information on the script, please type './board_rom.sh -help'.
