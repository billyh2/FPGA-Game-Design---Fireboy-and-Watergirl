...
HD_PWD='U:/ECE385/lab_7.1/lab_7.1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab7_1_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab7_1_top.tcl -notrace
